...
<html>
   ...
   <body>
      <h2>
         <fmt:message key="registration_page.header"/>
      </h2>
      <h4>
         <fmt:message key="registration_page.subheader1"/>
      </h4>
      <h4>
         <fmt:message key="registration_page.subheader2"/>
         <a href ="login">
            <fmt:message key="navbar.signin"/>
         </a>
      </h4>
